...
- SEIR compartmental process with detection using a continuous approximation of the binomial distribution 
  - Lay interpretation: we model the true number of infections as a hidden process that generates the observed case counts through a probabilistic detection mechanism.
...
- Allows an evolving recovery/incubation rate (E->I and I->R transitions) using a novel beta-binomial transition
