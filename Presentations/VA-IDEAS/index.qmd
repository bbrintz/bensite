...
## Domains of Interest as Collaborative Statistician {auto-animate=true}
...
- SEIR compartmental process modeling detection with a continuous approximation of the binomial distribution (no discrete priors in stan)
