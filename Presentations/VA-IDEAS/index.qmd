...
- Hurdle component separates structural zeros from low-intensity demand
- Negative binomial component handles overdispersion in nonzero counts
...
## Utah 211 call patterns (example figure)

![](call_spikes_timeseries_placeholder.png){height=500px}
