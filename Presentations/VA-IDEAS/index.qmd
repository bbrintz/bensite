...
- Latent SEIR compartmental process for true infections
  - Approximate binomial observation using a continuous Gaussian process
...
- Use a novel computational solution in stan to estimate these dynamics efficiently in Stan with non-informative priors
