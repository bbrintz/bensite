...
## The COMPAS data is a landmark dataset to study algorithmic fairness in recidivism prediction {auto-animate="true" .scrollable}
```r
library(fairness)
...
## The COMPAS data is a landmark dataset to study algorithmic fairness in recidivism prediction {auto-animate="true" visibility="uncounted" .scrollable}
```{r, include=T}
library(fairness)
library(tidyverse)
library(knitr)
