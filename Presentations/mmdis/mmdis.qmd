...
::: {data-id="Disparate Impact Remover" auto-animate-delay="0" style="background: #00000; width: 750px; height: 4500px; margin: 50px;"}
```{r,include=T,echo=F}
library(fairmodels)
...
::: {data-id="Disparate Impact Remover" style="background: #00000; width: 750px; height: 450px; margin: 50px;"}
...
::: {data-id="Disparate Impact Remover" style="background: #00000; width: 750px; height: 4500px; margin: 50px;"}
