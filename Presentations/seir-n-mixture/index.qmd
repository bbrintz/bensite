...
of prevalent cases like a SEIR latent space model
...
- a novel computational solution to estimating dynamics in a discrete
transmission model using a continuous approximation in STAN
