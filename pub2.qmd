...
<style>
  ...
  body {
    ...
    background-image:
      ...
      radial-gradient(circle at 82% 70%, var(--warm), transparent 42%),
      radial-gradient(circle at 52% 112%, rgba(122, 193, 255, 0.14), transparent 44%),
      linear-gradient(145deg, #050d20 0%, #0a1731 42%, #102047 74%, #061126 100%);
