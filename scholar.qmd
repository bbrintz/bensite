...
.pub-bubble:nth-child(6n+1) { transform: rotate(-4deg); }
.pub-bubble:nth-child(6n+2) { transform: rotate(3deg); }
.pub-bubble:nth-child(6n+3) { transform: rotate(-2deg); }
.pub-bubble:nth-child(6n+4) { transform: rotate(4deg); }
.pub-bubble:nth-child(6n+5) { transform: rotate(-3deg); }
.pub-bubble:nth-child(6n+6) { transform: rotate(2deg); }
